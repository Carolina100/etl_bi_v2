...
# ============================================================================
DAG_ID = "load_sx_ordem_servico_d_dag"
PIPELINE_DESCRIPTION = "Carga Oracle -> Snowflake DS -> dbt DW para SX_ORDEM_SERVICO_D"
TAGS = ["oracle", "snowflake", "dbt", "ds", "dw", "sx_ordem_servico_d"]
DBT_PROJECT_DIR = PROJECT_ROOT / "dbt" / "solix_dbt"
DBT_SELECT_MODELS = ["stg_ds__sx_ordem_servico_d", "dim_sx_ordem_servico_d"]
PIPELINE_TASK_ID = "run_ds_pipeline"
DW_PIPELINE_NAME = "dw_sx_ordem_servico_d_dbt"
DW_SOURCE_NAME = "DBT.SOLIX_BI.DS.SX_ORDEM_SERVICO_D"
DW_TARGET_NAME = "SOLIX_BI.DW.SX_ORDEM_SERVICO_D"
...
def load_sx_ordem_servico_d_dag():
    ...
    def run_ds_pipeline_task(request: dict[str, Any]) -> dict[str, Any]:
        from src.pipelines.load_sx_ordem_servico_d import run_pipeline
...
load_sx_ordem_servico_d = load_sx_ordem_servico_d_dag()
