...
PIPELINE_MONITOR_SPECS = [
    {
        ...
        "description": "pipeline incremental controlado de dimensao, previsto duas vezes ao dia",
...
with DAG(
    ...
    description="Monitora ausencia de execucoes esperadas nas tabelas CTL.",
    ...
    check_expected_pipeline_runs_task
