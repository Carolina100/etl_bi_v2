...
# ============================================================================
DAG_ID = "load_sx_operacao_d_dag"
PIPELINE_DESCRIPTION = "Carga Oracle -> Snowflake DS -> dbt DW para SX_OPERACAO_D"
TAGS = ["oracle", "snowflake", "dbt", "ds", "dw", "sx_operacao_d"]
DBT_PROJECT_DIR = PROJECT_ROOT / "dbt" / "solix_dbt"
DBT_SELECT_MODELS = ["stg_ds__sx_operacao_d", "dim_sx_operacao_d"]
PIPELINE_TASK_ID = "run_ds_pipeline"
DW_PIPELINE_NAME = "dw_sx_operacao_d_dbt"
DW_SOURCE_NAME = "DBT.SOLIX_BI.DS.SX_OPERACAO_D"
DW_TARGET_NAME = "SOLIX_BI.DW.SX_OPERACAO_D"
...
def load_sx_operacao_d_dag():
    ...
    def run_ds_pipeline_task(request: dict[str, Any]) -> dict[str, Any]:
        from src.pipelines.load_sx_operacao_d import run_pipeline
...
load_sx_operacao_d = load_sx_operacao_d_dag()
