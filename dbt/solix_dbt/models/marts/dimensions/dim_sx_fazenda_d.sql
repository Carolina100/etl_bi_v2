...
{% set WATERMARK_PIPELINE_NAME = 'dim_sx_fazenda_d' %}
...
business_rows as (
    select
        ...
        staged_source.AREA_METRO,
        staged_source.CD_PRODUTOR,
...
orphan_row as (
    select
        ...
        cast('-1' as varchar(20)) as CD_FAZENDA,
        cast('UNDEFINED' as varchar) as DESC_FAZENDA,
        cast('-1' as varchar(20)) as CD_TALHAO,
        cast('UNDEFINED' as varchar) as DESC_TALHAO,
        cast('-1' as varchar(20)) as CD_ZONA,
        cast(-999 as number(38, 8)) as AREA_METRO,
        cast(-999 as number(38, 0)) as CD_PRODUTOR,
