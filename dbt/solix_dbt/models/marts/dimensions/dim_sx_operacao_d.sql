...
{% set WATERMARK_PIPELINE_NAME = 'dim_sx_operacao_d' %}
...
business_rows as (
    select
        ...
        staged_source.CD_PROCESSO,
        upper(staged_source.DESC_PROCESSO) as DESC_PROCESSO,
...
orphan_row as (
    select
        ...
        cast('UNDEFINED' as varchar) as FG_TIPO_OPERACAO,
        cast(-1 as number(38, 0)) as CD_PROCESSO,
        cast('UNDEFINED' as varchar) as DESC_PROCESSO,
